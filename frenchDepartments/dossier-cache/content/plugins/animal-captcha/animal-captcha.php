...
<img src=" '.plugins_url('source/animal-captcha.php',__FILE__).'" border="0" height="120" id="animal-captcha-img" onclick="this.src=\''.plugins_url('source/animal-captcha.php',__FILE__).'?\'+Math.random();" style="cursor:pointer;" /><br />
